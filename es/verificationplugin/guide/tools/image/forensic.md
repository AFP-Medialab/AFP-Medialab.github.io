...
El análisis **forense de imágenes** tiene como objetivo detectar anomalías y posibles falsificaciones en la señal de la imagen. Es una herramienta compleja que implica un análisis matemático de la señal para detectar trazas en la compresión de la imagen, incoherencias en frecuencias, en la distribución de píxeles y en el ruido residual.
